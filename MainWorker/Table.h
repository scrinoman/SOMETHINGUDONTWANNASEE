...
static const vector<CRuleTable> grammarTable = {
	...
	CRT({ CRR("var_decl", { TokenType(15), TokenType(10), TokenType(6), TokenType(12) }, 52, Labels::START_FOR_VAR_DESC, Labels::END_FOR_VAR_DESC) }),
	CRT({ CRR("=", { TokenType(39) }, 131, Labels::LABEL_NONE, Labels::START_FOR_VAR_EXPR) }, TERMINAL),
	CRT({ CRR("right_part", { TokenType(23), TokenType(2), TokenType(3), TokenType(4), TokenType(5), TokenType(1), TokenType(29) }, 0, Labels::START_ARITHMETIC_OPERATION, Labels::END_ARITHMETIC_OPERATION) }, NEED_SLR_PARSING),
	CRT({ CRR(";", { TokenType(19) }, 133, Labels::END_FOR_VAR_EXPR, Labels::START_FOR_COND) }, TERMINAL),
	CRT({ CRR("cond_expr", { TokenType(23), TokenType(2), TokenType(3), TokenType(4), TokenType(5), TokenType(1), TokenType(45) }, 0, Labels::START_COND_EXPR, Labels::END_COND_EXPR) }, NEED_SLR_PARSING),
	CRT({ CRR(";", { TokenType(19) }, 135, Labels::END_FOR_COND) }, TERMINAL),
	CRT({ CRR("id", { TokenType(1) }, 136) }, TERMINAL),
	CRT({ CRR("=", { TokenType(39) }, 137, Labels::START_FOR_CHANGE) }, TERMINAL),
	CRT({ CRR("right_part", { TokenType(23), TokenType(2), TokenType(3), TokenType(4), TokenType(5), TokenType(1), TokenType(29) }, 0, Labels::START_ARITHMETIC_OPERATION, Labels::END_ARITHMETIC_OPERATION) }, NEED_SLR_PARSING),
	CRT({ CRR(")", { TokenType(24) }, 139, Labels::END_FOR_CHANGE) }, TERMINAL),

...
std::map<TokenType, std::string> tokenString = {
	...
	{ TokenType::SQUARE_BRACKET_L, "BRACKET_L" },
	{ TokenType::SQUARE_BRACKET_R, "BRACKET_R" },
	...
	{ TokenType::LESS, "CHEVRON_L" },
	{ TokenType::GREATER, "CHEVRON_R" },
	...
	{ TokenType::INTEGER_OCT_NUMBER, "INTEGER_OCT_NUMBER" },
	{ TokenType::INTEGER_HEX_NUMBER, "INTEGER_HEX_NUMBER" },

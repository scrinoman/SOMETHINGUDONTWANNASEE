...
static const vector<CRuleTable> grammarTable = {
	...
	CRT({ CRR("condition", { TokenType(14) }, 152) }, LAST_NONTERMINAL),
	...
	CRT({ CRR("empty", { TokenType(24) }, 0) }, EMPTY),
	CRT({ CRR("right_part", { TokenType(29), TokenType(1), TokenType(23), TokenType(2), TokenType(3), TokenType(4), TokenType(5) }, 0) }, NEED_SLR_PARSING),
